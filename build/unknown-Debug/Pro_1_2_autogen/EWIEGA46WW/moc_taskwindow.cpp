...
static constexpr auto qt_meta_stringdata_ZN10TaskWindowE = QtMocHelpers::stringData(
    "TaskWindow",
    "on_save_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10TaskWindowE[] = {
...
Q_CONSTINIT const QMetaObject TaskWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10TaskWindowE.offsetsAndSizes,
    qt_meta_data_ZN10TaskWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10TaskWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void TaskWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_BackToMain_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *TaskWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10TaskWindowE.stringdata0))
